...
|-----+-------+--------+-------------|
|   1 | 73800 |     10 |  1.3551e-05 |
|   2 | 17904 |     52 | 0.000290818 |
|   3 |  8820 |     51 | 0.000579741 |
|   4 | 12108 |     71 | 0.000587942 |
|   5 | 18220 |    145 | 0.000798693 |
|   6 | 10443 |     92 | 0.000884485 |
|   7 | 13950 |    173 |  0.00124712 |
|   8 | 11894 |    163 |  0.00137896 |
|   9 | 14615 |    284 |  0.00196041 |
|  10 | 12857 |    327 |  0.00257295 |
|  11 | 14174 |    430 |  0.00307595 |
|  12 | 12767 |    453 |  0.00360617 |
|  13 | 13669 |    555 |  0.00413643 |
|  14 | 13775 |    637 |  0.00472347 |
|  15 | 13135 |    678 |  0.00528575 |
|  16 | 12782 |    740 |  0.00594599 |
|  17 | 13445 |   1039 |  0.00801045 |
|  18 | 12760 |   1081 |  0.00881323 |
|  19 | 13137 |   1378 |   0.0110202 |
|  20 | 13253 |   1500 |   0.0119397 |
|  21 | 13437 |   1987 |   0.0158749 |
|  22 | 13263 |   2488 |   0.0205606 |
|  23 | 12975 |   3017 |   0.0261177 |
|  24 | 13270 |   4376 |    0.039223 |
|  25 | 13122 |   7887 |   0.0877966 |
...
#+RESULTS:
: The best moving window size is 85 pixels.
: The best slicing algorithm is 'ei'.

We can look at the relationship between observed and predicted deforestation in 1 x 1 km grid cells for the best model. We can see that the best model underestimates largely deforestation when deforestation is > 10 ha in 1.2 $\times$ 1.2 km cells.
...
#+RESULTS:
[[file:outputs_steps/pred_obs_ws85_ei.png]]

We can check if the predicted deforestation intensity (in ha) is similar to the observed deforestation intensity for the validation period.

#+begin_src python :results output :session :exports both
ofile = os.path.join(out_dir, f"pred_obs_ws{ws_hat}_{m_hat}.csv")
pred_obs = pd.read_csv(ofile)
tot_defor_obs = pred_obs["ndefor_obs"].sum()
tot_defor_pred = np.around(pred_obs["ndefor_pred"].sum())
print(f"Observed deforestation: {tot_defor_obs} ha")
print(f"Predicted deforestation: {tot_defor_pred} ha")
#+end_src

#+RESULTS:
: Observed deforestation: 40956 ha
: Predicted deforestation: 29457.0 ha

Using the JNR methodology, there is a large underestimation of the total amount of deforestation for the validation period.
