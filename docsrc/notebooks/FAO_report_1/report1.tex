...
\label{sec:org585f6c8}

\subsection{Context}
\label{sec:org0a7cebc}
...
\label{sec:orgaa991f1}

\subsection{Installation}
\label{sec:org2479dd6}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{outputs_steps/fcc123.png}
\caption{\label{fig:orgd97a781}\textbf{Forest cover change map.} Deforestation on the first period (2000--2010) is in orange, deforestation on the second period (2000--2020) is in red and remaining forest (in 2020) is in green.}
\end{figure}

\section{Steps to derive a categorical map of deforestation risk}
\label{sec:org0e4628b}

\subsection{Deforestation risk with distance to forest edge}
\label{sec:org337e276}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{outputs_steps/perc_dist_steps.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{outputs_steps/riskmap_steps.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{outputs_steps/pred_obs_steps.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{outputs_steps/pred_obs_corrected_steps.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{outputs_steps/map_comp.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{outputs_steps/pred_obs_ws5_ei.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{outputs_steps/riskmap_ws5_ei.png}
