...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" version="3.22.12-Białowieża" maxScale="0" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" classificationMin="1" classificationMax="10000" band="1" type="singlebandpseudocolor" opacity="1" nodataColor="">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0" classificationMode="1" maximumValue="10000" minimumValue="1" labelPrecision="0">
          <colorramp name="[source]" type="gradient">
            <Option type="Map">
              ...
              <Option name="stops" type="QString" value="0.00490049;255,165,0,255:0.00990099;215,25,28,255"/>
            </Option>
            <prop k="color1" v="34,139,34,255"/>
            <prop k="color2" v="0,0,0,255"/>
            <prop k="discrete" v="0"/>
            <prop k="rampType" v="gradient"/>
            <prop k="stops" v="0.00490049;255,165,0,255:0.00990099;215,25,28,255"/>
          </colorramp>
          <item alpha="255" label="1" color="#228b22" value="1"/>
